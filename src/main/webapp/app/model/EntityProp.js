Ext.define('Wsitms.model.EntityProp',{
	extend:'Wsitms.model.Base',
	
	fields:[{
		name:'id', type:'string', mapping:'ENTPROP_ID'
	},{
		...
		name:'PROPERTYVALUE', type:'string', convert:function(v,record){
