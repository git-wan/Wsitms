Ext.define('Wsitms.view.base.RoleController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.role-manage',
    
    requires:[
    	'Wsitms.view.base.RoleForm',
    	'Wsitms.view.base.Authority'
    ],
     ...
     setAuthClick:function(){
    	 ...
    	 var store = Ext.create('Ext.data.Store',{
    				...
    				proxy:{
    					type:'ajax',
    					api:{
    						 read: '/Wsitms/menu/roleMenu?USER_ROLE='+USER_ROLE
    					}
    			}});    	 
       	 ...
       	 var store1 = Ext.create('Ext.data.Store',{
             fields:[ 'MODULE_ID','DESCRIBE','GROUPNAME','MENU_ID'],
				...
				proxy:{
					type:'ajax',
					api:{
						 read: '/Wsitms/menu/userNoMenu?USER_ID='+USER_ID+'&USER_ROLE='+USER_ROLE  //'/Wsitms/menu/roleNoMenu?USER_ROLE='+USER_ROLE
					}
			}}); 
     ...
     rowclick:function( grid,record, element, rowIndex, e, eOpts){
     	 ...
     	 var store = Ext.create('Ext.data.Store', {
     	     ...
     	     proxy: {
     	         type: 'ajax',
     	         api:{
     	         read: '/Wsitms/menu/roleMenu?ROLE_NAME='+ROLE_NAME
     	         }
     	     }
     	 });
