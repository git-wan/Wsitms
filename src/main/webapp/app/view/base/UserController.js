Ext.define('Wsitms.view.base.UserController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.user-manage',
    
    requires:['Wsitms.view.base.UserForm','Wsitms.view.base.Authority'],
       	 ...
       	 var store1 = Ext.create('Ext.data.Store',{
             fields:[ 'MODULE_ID','DESCRIBE','GROUPNAME','MENU_ID'],
				...
				proxy:{
					type:'ajax',
					api:{
						 read: '/Wsitms/menu/userNoMenu?USER_ID='+USER_ID+'&USER_ROLE='+USER_ROLE
					}
			}}); 
