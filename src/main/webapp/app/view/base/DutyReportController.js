Ext.define('Wsitms.view.base.DutyReportController', {
	extend: 'Ext.app.ViewController',
	alias: 'controller.duty-report',

	requires: [
		'Wsitms.view.base.AseetForm',
		'Wsitms.view.base.Night',
		'Wsitms.view.base.Morning'
	],
	...
	morning: function () {
		window.location.href = 'http://localhost:8075/WebReport/ReportServer?reportlet=MorningShift.cpt&op=write'
	},

	night: function () {
		window.location.href = 'http://localhost:8075/WebReport/ReportServer?reportlet=NightShift.cpt&op=write'
	},
