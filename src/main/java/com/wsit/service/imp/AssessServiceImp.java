...
/*		ass_status.put("STATUS", pd.get("STATUS"));
	...
	public List<PageData> asjList(PageData pd) throws Exception {
		...
		return (List<PageData>) dao.findForList("AssMapper.asjList", null);
	}

	@Override
	public void addAssTime(PageData pd) throws Exception {
		pd.put("ID", UuidUtil.get32UUID());
		dao.save("AssTimeMapper.addAssTime", pd);
	...
	public List<PageData> assTimeList(PageData pd) throws Exception {
		...
		return (List<PageData>) dao.findForList("AssTimeMapper.assTimeList", null);
	}
